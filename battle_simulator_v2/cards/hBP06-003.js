 ...
 *   → 対象 (Q501/Q502): ①Buzzホロメン（top が Buzz・名前は問わない。〈風真いろは〉以外でも可）、
 *     または ②top が〈風真いろは〉で、その真下(stack[1])が Buzzホロメン（Buzzから Bloomした風真いろは）。
 *
...
// 送付対象 (Q501/Q502): ①Buzzホロメン（top が Buzz・名前不問）、
// または ②top が〈風真いろは〉で その真下(stack[1])が Buzzホロメン（Buzzから Bloomした風真いろは）。
function isBuzzIroha(e) {
  if (e.top.buzz) return true; // Buzzホロメン（〈風真いろは〉以外も可）
  return e.top.name === '風真いろは' && !!e.holomem.stack[1]?.buzz;
}
