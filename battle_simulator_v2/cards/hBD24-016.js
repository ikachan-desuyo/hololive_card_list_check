...
export default {
  ...
  spOshiSkill: {
    ...
    *run(ctx) {
      const cand = ctx.deckCards((c) => c.kind === 'holomen' && (c.color || '').includes('青'));
      const picked = yield ctx.chooseCard({
        cards: cand,
        title: 'デッキから青ホロメン1枚を公開して手札に加える',
        optional: true,
